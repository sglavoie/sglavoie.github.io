...
date: "2021-05-30T13:13:00"
lastmod: "2022-04-03T11:49:00"
...
For more information about this, you can read the article [Setting up SSH and Git for Multiple Accounts]({{< ref "/posts/setting-up-ssh-and-git-for-multiple-accounts" >}}) if you'll be using an SSH key to connect and more specifically [the official documentation on the `git remote` command](https://git-scm.com/docs/git-remote).
