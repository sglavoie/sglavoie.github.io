...
date: "2023-01-02T09:52:00"
slug: git-worktrees-for-a-better-parallel-workflow
author: Sébastien Lavoie
summary: "Git leads to a wealth of discoveries. Once [SSH and GPG are set up](/posts/setting-up-ssh-and-git-for-multiple-accounts/), once [dotfiles are under control](/posts/managing-dotfiles-with-git-bare-repository/) and a reasonable [Git workflow has been adopted](/posts/git-the-gist-of-it-common-commands-for-a-working-workflow/), there's still room to be amazed by a feature like Git worktrees!"
...
- [Git the gist of it: common commands for a working workflow]({{< ref "/posts/git-the-gist-of-it-common-commands-for-a-working-workflow" >}})
- [Managing dotfiles with a Git bare repository]({{< ref "/posts/managing-dotfiles-with-git-bare-repository" >}})
- [Setting up SSH and Git for Multiple Accounts]({{< ref "/posts/setting-up-ssh-and-git-for-multiple-accounts" >}})
