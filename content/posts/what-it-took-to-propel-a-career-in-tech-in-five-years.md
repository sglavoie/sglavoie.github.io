...
The output below was formatted automatically with a tool that converts the content of a Google Sheet into Markdown. If you're curious, you might enjoy reading [this article]({{< ref "/posts/using-google-sheets-as-a-database-to-extract-data-converted-to-markdown" >}})!
...
[2021]({{< ref "/learning-progress-2021" >}})
