...
- With calculations involving both addition/substraction and multiplication/division, it is best to perform the multiplication/division first to reduce precision loss.
...
- `make` can be used to initialize a map with a specific size (second argument to `make`, without capacity). This avoids having to grow the map and rebalancing all the buckets of 8 elements each.
